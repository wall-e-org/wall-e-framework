...
public class SnowFlakeUtil {
    ...
    private static final Map<String, SnowFlakeUtil> instances = new HashMap<String, SnowFlakeUtil>();

    public static SnowFlakeUtil getInstance(long datacenterId, long machineId){
        String key = datacenterId + "-" + machineId;
        SnowFlakeUtil instance = instances.get(key);
        if(null == instance){
